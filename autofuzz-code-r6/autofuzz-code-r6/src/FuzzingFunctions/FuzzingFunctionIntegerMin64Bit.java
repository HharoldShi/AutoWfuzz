 ...
 *
 */
public class FuzzingFunctionIntegerMin64Bit implements FuzzingFunctionInterface{
	...
	public ArrayList<Integer> fuzzInputMsg(GenericSequence genericMessage,
		...
		int[] maxValue = { 45, 57, 50, 50, 51, 51, 55, 50, 48, 51, 54, 56, 53, 52, 55, 55, 53, 56, 48, 56  } ;
